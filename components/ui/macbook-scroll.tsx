  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="text-white text-6xl sm:text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
...
const JLLogo = () => {
  return (
    ...
    >
      <path
        d="M 29.6 0 L 31.6 0 L 31.6 56.1 A 17.104 17.104 0 0 1 30.825 61.357 A 14.139 14.139 0 0 1 27.55 66.85 Q 23.5 71.1 16.3 71.1 A 20.299 20.299 0 0 1 11.357 70.533 A 13.69 13.69 0 0 1 4.25 66.3 Q 0.352 61.897 0.029 54.466 A 31.492 31.492 0 0 1 0 53.1 L 2 53.1 A 23.739 23.739 0 0 0 2.54 58.297 A 16.819 16.819 0 0 0 5.4 64.7 Q 8.561 68.977 15.266 69.277 A 23.091 23.091 0 0 0 16.3 69.3 Q 20.749 69.3 23.627 67.749 A 9.074 9.074 0 0 0 26.5 65.35 A 14.51 14.51 0 0 0 29.599 56.286 A 18 18 0 0 0 29.6 56.1 L 29.6 0 Z M 50.1 0 L 50.1 68.6 L 77.1 68.6 L 77.1 70.4 L 48.1 70.4 L 48.1 0 L 50.1 0 Z"
        stroke="currentColor"
        strokeWidth="7"
